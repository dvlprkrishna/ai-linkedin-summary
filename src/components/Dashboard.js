...
export default function Dashboard() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("/api/returnLiSummary", {
      method: "POST",
      headers: {
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                name="keyWords"
                id="keyWords"
                placeholder="Keywords for AI (Optional) Example - Web Developer, Java Developer, API's"
                className="block w-full rounded-md bg-white border border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 placeholder-gray-500 my-2 text-gray-900"
              />
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                type="number"
                className="block w-full rounded-md bg-white border border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 placeholder-gray-500 my-2 text-gray-900"
                placeholder="Number Of Words - Default 300 words (Optional)"
                name="words"
                id="words"
              />
            </div>
        ...
        <div className="">
          <div className="flex flex-col">
            ...
            <textarea
              ...
              id="output"
              placeholder="AI Generated Linkedin Summary"
              className="block w-full rounded-md bg-white border border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 placeholder-gray-500 my-2 text-gray-900"
            />
            <button
              onClick={handleCopy}
